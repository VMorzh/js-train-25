...
async function getDataFromUrl(url) {
  ...
  try {
    ...
    if (!response.ok) {
      throw new Error("Помилка при отриманні даних"); // Викидаємо помилку, якщо відповідь не вдала
    }
    ...
    console.error("Помилка:", error.message); // Виводимо помилку в консоль, якщо виникла помилка під час виконання запиту
  }
}
// Розкоментуйте після виконання завданння
